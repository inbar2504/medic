...
function Roles(props) {
  ...
  >
    ...
    <p style={{ fontSize: "5vmin" }}>המנהל האג"מי- אחראי על סידור הזירה,איסוף הנתונים, חלוקת המשימות, יישום ההנחיות של המפקד הרפואי, דיווח וחבירה לגורמים נוספים</p>
    <p>דפדפו כדי לראות את תחומי האחריות</p>
    <Page1
  ...
  items={["מפקד חוליה רפואית","מטפל בכיר","חובש בחוליה",'מע"ר בחוליה']}>
    ...
    <p style={{ fontSize: "5vmin" }}>המנהל הרפואי-המטפל הבכיר ביותר באירוע (רופא/פראמדיק/חובש) שהוגדר בתור חובש בכיר באירוע</p>
    <p>דפדפו כדי לראות את תחומי האחריות</p>
    <Page1
    randomRotation={true}
    sensitivity={180}
  ...
  <h2>תפקידי החובש בחוליה</h2>
    <p style={{ fontSize: "5vmin" }}>על החובש מוטלת האחריות הראשונית לטיפול רפואי בחולים בזמן שגרה ובעת חירום. </p>
    <p>דפדפו כדי לראות את תחומי האחריות</p>
    <Page1
    randomRotation={true}
    sensitivity={180}
  ...
  items={["מפקד חוליה רפואית","מטפל בכיר","חובש בחוליה",'מע"ר בחוליה']}>
    ...
    <p style={{ fontSize: "5vmin" }}>מגיש עזרה ראשונה (בראשי תיבות: מע"ר) הוא אדם שעבר קורס בעזרה ראשונה.</p>
    <p>דפדפו כדי לראות את תחומי האחריות</p>
    <Page1
    randomRotation={true}
    sensitivity={180}
