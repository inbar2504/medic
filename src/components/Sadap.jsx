...
function Sadap(props) {
  ...
  return (
    ...
    <img id="strt-img" src="./assets/strt.png"/>
      <button id="con-btn" onClick={ () => setShowStart(false)}>המשך</button>
    </div>
}
      <Stepper
      ...
      >
        ...
        >
          ...
          >
            ...
            <button
              ...
              onClick={() => setImg(2)}
            >
              דיווח מלא לאחר סיכום טריאג'
            </button>
          </div>
          {showImg1 && <img className="images12" src="./assets/img1.png" />}
          {showImg2 && <img className="images12" src="./assets/img2.png" />}
        </Step>
        <Step
          items={['בהגעה לאר"ן', "דיווחים", "ריכוז הפצועים", "סיכום טריאג'"]}
        >
        ...
        <p className="piska"> 
         אם יש ירוק בעיניים וודאי, לעלות בקשר שנמצאו כל הפצועים, אם לא, לעלות שלא ידוע אם יש עוד פצועים
        </p>
      </div>
      <div id="medic">
        <h2
        ...
        <p className="piska">
להתחיל מעבר על הפצועיםת מט"ב/חובש שמוגדר חובש בכיר יחד עם המח"ר-טריאז'
        </p>
      </div>
      <div id="table">
        <h2
        ...
        <p className="piska"> 
        בטריאג' עושים מעבר זריז על כל פצוע (A,B חצי C), והמח"ר כותב בטבלה את כל הדברים הרלוונטיים
        </p>
      </div>
      <div id="hat">
        <h2
        ...
        <p className="piska">
          בזמן הטריאז' ,החובשים והלוחמים מריצים סכמה מהירה על הפצועים שעוד לא הגיעו אליהם ומכינים אותם לפינוי (לא מפריעים למט"ב)
        </p>
      </div>
        <div className="ico">
            <div className="icons" onClick={ () => document.getElementById("eye").style.display = "block"}><img className="icon1" src="./assets/icon-eye.png"/></div>
            <div className="icons" onClick={ () => document.getElementById("hat").style.display = "block"}><img className="icon1" src="./assets/hat-icon.png"/></div>
            <div className="icons" onClick={ () => document.getElementById("table").style.display = "block"}><img className="icon2" src="./assets/table-icon.png"/></div>
            <div className="icons" onClick={ () => document.getElementById("medic").style.display = "block"}><img className="icon2" src="./assets/medic-icon.png"/></div>
        </div>
        </Step>
        <Step
          items={['בהגעה לאר"ן', "דיווחים", "ריכוז הפצועים", "סיכום טריאג'"]}
        >
          <h2>סיכום טריאג' והמשך טיפול</h2>
          <p>
          לאחר סיום הטריאז’ תתכנס החוליה הרפואית, תסכם את המידע שנאסף עד כה לגבי הפצועים ותגזור משמעויות ומשאבים לטיפול
          <br />
