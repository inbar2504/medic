...
export default function Stepper({
  ...
  // const names = ["מפקד חוליה רפואית","dfgbhn","sdfvb","sdfg"];
    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: "#192318", color: "#00d8ff" },
      ...
      {/* <div>
      {items.map((item, index) => (
        <span>{item}{index < items.length - 1 && ", "}</span>  // מפריד בין פריטים עם פסיק
      ))}
    </div> */}
      {/* <div>מפקד חוליה רפואית</div> */}
    </motion.div>
  );
}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    incomplete: { width: 0, backgroundColor: "#ffffff" },
